            ...
            <div class="container">
                <div class="sign-area">
                    <form class="sign-in-form" method="post" enctype="multipart/form-data"
                          action="<?= URLROOT ?>user/CreateReportController/createReport">
                        <h2 class="sub-title">انشاء بلاغ</h2>

                        <div class="reports-type">
                            <div class="reports-type-logo">
                                <img src="<?= ASSETS_ROOT ?>user/img/<?= $data->img ?>" alt="reports-type">
                            </div>

                            <h3 class="reports-type-title">بلاغات <?= $data->specialization ?></h3>

                        </div>

                        <div class="reports-location">
                            <span class="reports-location-btn">  <?= $data->information ?></span>
                        </div>
